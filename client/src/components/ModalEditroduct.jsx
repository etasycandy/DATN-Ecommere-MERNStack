...
function ModalEditProduct({
  ...
  return (
    <div className="scroll-none relative bg-white rounded-lg px-2 w-2/3 h-[90%] overflow-auto modal_container z-[60]">
      <div className="p-3 ">
        ...
        <div className="mt-4">
          <form className="w-full" onSubmit={handleSubmit}>
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-6/12 pr-6"></div>
              <div className="w-full md:w-6/12 pl-6">
                  ...
                  <div className="flex flex-wrap px-16 mb-3">
                    {sizes.map((size) => (
                      <div
                        key={size}
                        className={
                          sizeList.includes(size) ? 'size-active-edit' : 'size'
                        }
                        name="size"
              ...
              <div className="w-full py-3">
                ...
                <div className="flex items-center justify-center w-full">
                  <label
                    ...
                    className="flex flex-col items-center justify-center w-full h-20 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                  >
                ...
                {errorVali.img && (
                  <span className="text-err text-red-700">{errorVali.img}</span>
                )}
              </div>
              <div className="w-full py-3 text-black">
                <label
                  htmlFor="description"
                  className="label block mb-2 text-sm text-gray-700"
                >
